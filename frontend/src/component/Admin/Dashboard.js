...
import { getAdminProducts, clearErrors } from '../../store/actions/productAction';
...
const Dashboard = () => {
    ...
    return <FormContainer pagetitle={'Dashboard'}>
        {loading || allOrdersLoading || allUsersLoading ? <Loader /> : <>
