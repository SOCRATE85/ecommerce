...
const UserComponent = ({user}) => {
    ...
    return (<>
        {updateLoading || user.length === 0 ? <Loader /> : <FormAction submitHandler={updateUserSubmitHandler}>
            ...
            <ControlContainer id="createProductFormImage">
                {
                    imagePreview && <img src={imagePreview} alt="Avatar Preview" style={{width: 150, height: undefined}} />
                }
            </ControlContainer>
