...
const EditAttribute = () => {
  ...
  return (
    <>
      <FormContainer pagetitle={"Edit Attributes"}>
        {loadingAttributeDetails || updateLoading ? (
          <Loader />
        ) : (
          <FormAction submitHandler={updateAttributeSubmitHandler}>
            ...
            {(frontendInput === "select" ||
              ...
              <>
                ...
                <div className="attributeOptionContainer">
                  {attributeOptionFormElementArray.length !== 0 &&
                            ...
                            return (
                              ...
                              >
                                <Input
                                  ...
                                  label={
                                    attribute.config.elementConfig.placeholder
                                  }
