...
const UpdateProduct = () => {
        ...
        for (let _key in attributes) {
          ...
          switch (attributes[_key].frontend_input) {
            ...
            case "select":
              ...
              break;
            case "date":
              let updateDate = moment(new Date(value).getTime()).format(
                "yyyy-MM-DD"
              );
              attributeForm[attributes[_key].attribute_code] = {
                elementType: attributes[_key].frontend_input,
  ...
  return (
    <FormContainer pagetitle={"Update Product"}>
      <FormAction submitHandler={updateProductSubmitHandler}>
        ...
        {formElementArray.map(
          ({ attributeGroupId, attributeGroup, attributes }, index) => {
            return (
              <FieldSet legend={attributeGroup} key={attributeGroupId}>
                    ...
                    case "checkbox":
                      return (
                        <Input
                          ...
                          removeImage={removeImage}
                          changed={(e) =>
                            checkboxOptionChangeHandler(e, index, attribute.id)
                          }
                        />
                      );
                    case "file":
