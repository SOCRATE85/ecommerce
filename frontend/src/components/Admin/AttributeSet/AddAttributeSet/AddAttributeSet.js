...
import { getAllAttributes, clearErrors, createAttributeSet, createAttributeSetReset, getAttributeSets } from "../../../../store";
...
const AddAttributeSet = () => {
    ...
    const saveAttributeSetHandler = () => {
        ...
        myForm.set("attributeSetReference", attributeSetReference ? attributeSetReference :  ref.current.value);
    ...
    return (<FormContainer pagetitle={"Add AttributeSet"}>
        {loading || createLoading ? <Loader /> : <div className="attributesetnamecontainer">
            ...
            <div>
                <SpellcheckOutlined />
                <select ref={ref} onChange={e => setAttributeSetReference(e.target.value)}>
