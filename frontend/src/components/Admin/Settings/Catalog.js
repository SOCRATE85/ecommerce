...
export const Catalog = (props) => {
    ...
    const {settings, loading: loadingSettings} = useSelector(state => state.getSettings);
    ...
    const [useCategoryPathForProductUrls, setUseCategoryPathForProductUrls] = useState(false);
    const [pageTitleSeparator, setPageTitleSeparator] = useState("");
    const [useCanonicalLinkForCategoryPage, setUseCanonicalLinkForCategoryPage] = useState("");
    const [useCanonicalLinkForProductPage, setUseCanonicalLinkForProductPage] = useState("");
    ...
    useEffect(() => {
        if(!loadingSettings && settings.length !== 0) {
            ...
            if(getToolbarValue(settings, "catalog/per_page_in_grid_default")) {
                setPerPageInGridDefault(getToolbarValue(settings, "catalog/per_page_in_grid_default"));
            }
            ...
            if(getToolbarValue(settings, "catalog/per_page_in_list_default")) {
                setPerPageInListDefault(getToolbarValue(settings, "catalog/per_page_in_list_default"));
            }
            ...
            if(getToolbarValue(settings, "catalog/product_url_suffix")) {
                setProductUrlSuffix(getToolbarValue(settings, "catalog/product_url_suffix"));
            }
            if(getToolbarValue(settings, "catalog/category_url_suffix")) {
                setCategoryUrlSuffix(getToolbarValue(settings, "catalog/category_url_suffix"));
            }
            if(getToolbarValue(settings, "catalog/use_category_path_for_product_urls")) {
                setUseCategoryPathForProductUrls(getToolbarValue(settings, "catalog/use_category_path_for_product_urls"));
            }
            if(getToolbarValue(settings, "catalog/page_title_separator")) {
                setPageTitleSeparator(getToolbarValue(settings, "catalog/page_title_separator"));
            }
            if(getToolbarValue(settings, "catalog/use_canonical_link_for_category_page")) {
                setUseCanonicalLinkForCategoryPage(getToolbarValue(settings, "catalog/use_canonical_link_for_category_page"));
            }
            if(getToolbarValue(settings, "catalog/use_canonical_link_for_product_page")) {
                setUseCanonicalLinkForProductPage(getToolbarValue(settings, "catalog/use_canonical_link_for_product_page"));
            }
        }
                ...
                <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                    ...
                    <AccordionDetails>
                        <div className="setting_row">
                            ...
                            <select id="list_mode" onChange={(e) => setListMode(e.target.value)} defaultValue={listMode}>
                        ...
                        <div className="setting_row">
                            ...
                            <select onChange={(e) => setListSortBy(e.target.value)} defaultValue={listSortBy}>
                        ...
                        <div className="setting_row">
                            ...
                            <select onChange={(e) => setAllowAll(e.target.value)} defaultValue={allowAll}>
                ...
                <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
                    ...
                    <AccordionDetails>
                        ...
                        <div className="setting_row">
                            ...
                            <select onChange={(e) => setUseCategoryPathForProductUrls(e.target.value)} defaultValue={useCategoryPathForProductUrls}>
                                <option value={"yes"}>Yes</option>
                                <option value={"no"}>No</option>
                            </select>
                        </div>
                        ...
                        <div className="setting_row">
                            ...
                            <select 
                                onChange={(e) => setUseCanonicalLinkForCategoryPage(e.target.value)} 
                        ...
                        <div className="setting_row">
                            ...
                            <select 
                                onChange={(e) => setUseCanonicalLinkForProductPage(e.target.value)} 
